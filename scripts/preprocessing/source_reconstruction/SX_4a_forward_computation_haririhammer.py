...
fig.savefig(pathjoin(subj_preprocpath, "haririhammer", "bem_oct6_src.png"))
...
mne.write_forward_solution(pathjoin(subj_preprocpath, "haririhammer", "forward-fwd.fif"), fwd, overwrite=True)
print(f"Forward solution saved to {pathjoin(subj_preprocpath, 'haririhammer', 'forward-fwd.fif')}")