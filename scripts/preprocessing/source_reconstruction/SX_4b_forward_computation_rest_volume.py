...
fig.savefig(pathjoin(subj_preprocpath, "rest", "bem_vol_src.png"))
...
mne.write_forward_solution(pathjoin(subj_preprocpath, "rest", "forward_volume-fwd.fif"), fwd, overwrite=True)
print(f"Forward solution saved to {pathjoin(subj_preprocpath, 'rest', 'forward_volume-fwd.fif')}")