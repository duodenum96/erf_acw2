...
# Import ACW data
acw_results = pklload(f"/BICNAS2/ycatal/erf_acw2/results/int_fooof/rest_ints.pkl")
acws = 1 / (2*np.pi * acw_results["rest_ints"])
...
data.to_csv("/BICNAS2/ycatal/erf_acw2/results/data_st_fooof.csv")