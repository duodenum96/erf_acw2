...
f = h5py.File(
    "/BICNAS2/ycatal/erf_acw2/scripts/modeling/results/sensitivity_control_pythonic_tau_different.jld2",
    "r",
)
...
plt.suptitle(r"$ \tau_E = 5, \tau_I = 50 $")
f.savefig(join(figpath, "supplementary_sensitivity_control_tau_different.png"), dpi=300, transparent=True)
