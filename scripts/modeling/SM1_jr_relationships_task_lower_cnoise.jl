...
# nohup julia -t 20 SM1_jr_relationships_task_lower_cnoise.jl > log/SM1_jr_relationships_task_lower_cnoise.log 2>&1 &
# echo $! > log/SM1_jr_relationships_task_lower_cnoise.pid
...
jldsave(joinpath(savepath, "supplementary_sensitivity_control_task_lower_cnoise.jld2"); all_erfs=all_erfs)
println("DONE")
