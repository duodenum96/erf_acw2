...
# nohup julia -t 20 SM0_jr_relationships_lower_cnoise.jl > log/SM0_jr_relationships_lower_cnoise.log &
# echo $! > log/SM0_jr_relationships_lower_cnoise.pid
using Pkg
cd("/BICNAS2/ycatal/erf_acw2/scripts/modeling")
Pkg.activate(".")
...
jldsave(joinpath(savepath, "supplementary_sensitivity_control_rest_lower_cnoise.jld2");
        all_acw50s=all_acw50s)
jldsave(joinpath(savepath, "supplementary_sensitivity_control_rest_lower_cnoise_acf_and_psd.jld2");
