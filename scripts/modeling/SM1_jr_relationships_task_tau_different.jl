...
# nohup julia -t 20 SM1_jr_relationships_task_tau_different.jl > log/SM1_jr_relationships_task_tau_different.log 2>&1 &
# echo $! > log/SM1_jr_relationships_task_tau_different.pid
...
jldsave(joinpath(savepath, "supplementary_sensitivity_control_task_tau_different.jld2"); all_erfs=all_erfs)
println("DONE")
