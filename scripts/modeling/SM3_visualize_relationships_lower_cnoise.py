...
f = h5py.File(
    "/BICNAS2/ycatal/erf_acw2/scripts/modeling/results/sensitivity_control_pythonic_lower_cnoise.jld2", 
    "r",
)
...
plt.suptitle("$c_{noise} = 0.03$")
f.savefig(join(figpath, "supplementary_sensitivity_control_lower_cnoise.png"), dpi=300, transparent=True)
