...
# nohup julia -t 20 SM0_jr_relationships_tau_different.jl > log/SM0_jr_relationships_tau_different.log &
# echo $! > log/SM0_jr_relationships_tau_different.pid
...
jldsave(joinpath(savepath, "supplementary_sensitivity_control_rest_tau_different.jld2");
        all_acw50s=all_acw50s)
jldsave(joinpath(savepath, "supplementary_sensitivity_control_rest_tau_different_acf_and_psd.jld2");
