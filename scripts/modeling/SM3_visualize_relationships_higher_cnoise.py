...
f = h5py.File(
    "/BICNAS2/ycatal/erf_acw2/scripts/modeling/results/sensitivity_control_pythonic_higher_cnoise.jld2",
    "r",
)
...
plt.suptitle("$c_{noise} = 0.1$")
f.savefig(join(figpath, "supplementary_sensitivity_control_higher_cnoise.png"), dpi=300, transparent=True)
