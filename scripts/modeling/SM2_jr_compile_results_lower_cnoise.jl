...
all_acws = jldopen(joinpath(savepath, "supplementary_sensitivity_control_rest_lower_cnoise.jld2"), "r")["all_acw50s"]
all_erfs = jldopen(joinpath(savepath, "supplementary_sensitivity_control_task_lower_cnoise.jld2"), "r")["all_erfs"]
...
for testval_name in testvals_names
    ...
    # Save the figure
    Plots.savefig(joinpath(figpath, "sensitivity_$(testval_name)_lower_cnoise.png"))
end
...
jldsave(joinpath(savepath, "sensitivity_control_pythonic_lower_cnoise.jld2"), 
