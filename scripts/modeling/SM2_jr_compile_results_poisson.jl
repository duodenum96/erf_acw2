...
all_erfs = jldopen(joinpath(savepath, "supplementary_sensitivity_control_task_poisson.jld2"), "r")["all_erfs"]
...
for testval_name in testvals_names
    ...
    # Save the figure
    Plots.savefig(joinpath(figpath, "sensitivity_$(testval_name)_poisson.png"))
end
...
jldsave(joinpath(savepath, "sensitivity_control_pythonic_poisson.jld2"), 
