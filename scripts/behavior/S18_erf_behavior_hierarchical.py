...
# nohup python S20_erf_behavior_hierarchical.py > log/hierarchical_nuts.log &
# pid: 3940900
import os
import numpy as np
import pandas as pd
...
trace.to_netcdf("/BICNAS2/ycatal/erf_acw2/results/hierarchical_model/erf_rt_hierarchical.cdf")
cloud_pklsave("/BICNAS2/ycatal/erf_acw2/results/hierarchical_model/erf_rt_hierarchical.pkl", model)
