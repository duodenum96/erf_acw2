...
# nohup python S18_erf_acw_hierarchical_oscillatory_fit.py > log/hierarchical_nuts_erf_acw_oscillatory_fit.log &
# echo $! > log/pid_hierarchical_nuts_erf_acw_oscillatory_fit.txt
import os
import numpy as np
import pandas as pd
import pymc as pm
