...
data_other = pd.read_csv("/BICNAS2/ycatal/erf_acw2/results/data_st_oscillatory_fit_whole_poststim.csv")
data["alpha_powers"] = data_other["alpha_powers"]
...
results = az.from_netcdf(join(resultpath, "idata_acw_erf_control_alpha.nc"))
...
summary.to_csv(join(figpath_supp, "summary_acw_erf_control_alpha.csv"))
...
f.savefig(join(figpath_supp, "prior_and_posterior_acw_erf_control_alpha.png"), dpi=300)
...
plt.savefig(join(figpath_supp, "trace_acw_erf_control_alpha.png"), dpi=300)
...
f.savefig(join(figpath_supp, "forest_acw_erf_control_alpha.png"), dpi=300)
...
plot_channel_effects(
    ...
    vlim=vlims,
    title="mERF|Channel",
    figpath=join(figpath, "channels_erf_acw_control_alpha.jpg"),
    mask=mask_erf,
)
...
plot_channel_effects(
    ...
    figpath=join(figpath, "channels_erf_acw_plus_control_alpha.jpg"),
    mask=mask_erf_plus,
)
