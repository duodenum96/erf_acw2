...
# nohup python S18_erf_acw_hierarchical_oscillatory_fit_whole_poststim.py > log/hierarchical_nuts_erf_acw_oscillatory_fit_whole_poststim.log &
# echo $! > log/pid_hierarchical_nuts_erf_acw_oscillatory_fit_whole_poststim.txt
import os
import numpy as np
import pandas as pd
import pymc as pm
...
idata.to_netcdf(join(resultpath, "idata_acw_erf_oscillatory_fit_whole_poststim.nc"))
