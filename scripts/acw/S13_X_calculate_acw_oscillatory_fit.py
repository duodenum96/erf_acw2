...
popts, acws, acfs = loop_oscillatory_fitting(epochs_meg, nchan=nchan, ntrial=ntrial_new, nlags=nlags)

toc = time.time() - tic
print(f"Elapsed time: {toc}")

fname = "/BICNAS2/ycatal/erf_acw2/results/int/rest/" + i_subj + "_rest_acw_oscillatory_fit.pkl"
