...
data = pd.read_csv("/BICNAS2/ycatal/erf_acw2/results/data_st_oscillatory_fit_whole_poststim.csv")
data = data.rename(
    columns={
        "erfs": "mERF",
        "restacws": "ACW",
...
results = az.from_netcdf(join(resultpath, "idata_acw_erf_oscillatory_fit_whole_poststim.nc"))
...
summary.to_csv(join(figpath_supp, "summary_acw_erf_oscillatory_fit_whole_poststim.csv"))
...
f.savefig(join(figpath_supp, "prior_and_posterior_acw_erf_oscillatory_fit_whole_poststim.png"), dpi=300)
...
plt.savefig(join(figpath_supp, "trace_acw_erf_oscillatory_fit_whole_poststim.png"), dpi=300)
...
f.savefig(join(figpath_supp, "forest_acw_erf_oscillatory_fit_whole_poststim.png"), dpi=300)
...
plot_channel_effects(
    ...
    vlim=vlims,
    title="mERF|Channel",
    figpath=join(figpath, "channels_erf_acw_oscillatory_fit_whole_poststim.jpg"),
    mask=mask_erf
)
...
plot_channel_effects(
    ...
    figpath=join(figpath, "channels_erf_acw_plus_oscillatory_fit_whole_poststim.jpg"),
    mask=mask_erf_plus
)
