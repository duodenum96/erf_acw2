...
# nohup python S18_erf_acw_hierarchical_control_alpha.py > log/hierarchical_nuts_erf_acw_control_alpha.log &
# echo $! > log/pid_hierarchical_nuts_erf_acw_control_alpha.txt
import os
import numpy as np
import pandas as pd
import pymc as pm
...
idata.to_netcdf(join(resultpath, "idata_acw_erf_control_alpha.nc"))
