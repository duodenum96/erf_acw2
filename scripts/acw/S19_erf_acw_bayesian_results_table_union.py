...
results = az.from_netcdf(join(resultpath, "idata_acw_erf_union.nc"))
...
summary.to_csv(join(figpath_supp, "summary_acw_erf_union.csv"))
...
f.savefig(join(figpath_supp, "prior_and_posterior_acw_erf_union.png"), dpi=300)
...
plt.savefig(join(figpath_supp, "trace_acw_erf_union.png"), dpi=300)
...
f.savefig(join(figpath_supp, "forest_acw_erf_union.png"), dpi=300)
...
plot_channel_effects(
    ...
    vlim=vlims,
    title="mERF|Channel",
    figpath=join(figpath, "channels_erf_acw_union.jpg"),
    mask=mask_erf
)
...
plot_channel_effects(
    ...
    figpath=join(figpath, "channels_erf_acw_union_plus.jpg"),
    mask=mask_erf_plus
)
